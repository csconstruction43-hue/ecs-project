// pages/ecs-cards/SiteSupervisorPage.jsx — dedicated ECS card page for "Site Supervisor"
...
const CARD = {
  ...
  desc: `Supervisory-level card for overseeing electrotechnical work on site.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Site Supervisor card?`, a: `Yes. This route sits behind the Supervisors HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Site Supervisor card last?`, a: `5 years, in line with the Gold Card (Supervisor) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Site Supervisor the right card for my role?`, a: `It's one of several routes under Site Management. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
