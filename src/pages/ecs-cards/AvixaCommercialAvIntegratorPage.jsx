// pages/ecs-cards/AvixaCommercialAvIntegratorPage.jsx — dedicated ECS card page for "AVIXA Commercial AV Integrator"
...
const CARD = {
  name: `AVIXA Commercial AV Integrator`,
  slug: 'avixa-commercial-av-integrator',
  desc: `AV integration specialist route recognised via AVIXA pathways.`,
...
const faqs = [
    { q: `Do I need to sit a test for the AVIXA Commercial AV Integrator card?`, a: `Yes. This route sits behind the Operatives or Specialist HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the AVIXA Commercial AV Integrator card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is AVIXA Commercial AV Integrator the right card for my role?`, a: `It's one of several routes under AV, Broadcast & Creative Production. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function AvixaCommercialAvIntegratorPage() {
