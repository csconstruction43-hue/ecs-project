// pages/ecs-cards/ElectricalLabourerPage.jsx — dedicated ECS card page for "Electrical Labourer"
...
const CARD = {
  name: `Electrical Labourer`,
  slug: 'electrical-labourer',
  desc: `For workers assisting qualified electricians on electrical sites.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Electrical Labourer card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Electrical Labourer card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Electrical Labourer the right card for my role?`, a: `It's one of several routes under Entry & General Routes. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function ElectricalLabourerPage() {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link
              to="/ecs-cards/industry-placement-t-level"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">Industry Placement (T-Level)</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">For T-Level students completing a supervised industry placement.</p>
              </div>
            </Link>
        </div>
      </section>
