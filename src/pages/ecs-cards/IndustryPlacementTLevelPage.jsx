// pages/ecs-cards/IndustryPlacementTLevelPage.jsx — dedicated ECS card page for "Industry Placement (T-Level)"
...
const CARD = {
  name: `Industry Placement (T-Level)`,
  slug: 'industry-placement-t-level',
  desc: `For T-Level students completing a supervised industry placement.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Industry Placement (T-Level) card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Industry Placement (T-Level) card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Industry Placement (T-Level) the right card for my role?`, a: `It's one of several routes under Entry & General Routes. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function IndustryPlacementTLevelPage() {
