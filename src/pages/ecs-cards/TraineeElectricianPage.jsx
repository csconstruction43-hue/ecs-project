// pages/ecs-cards/TraineeElectricianPage.jsx — dedicated ECS card page for "Trainee Electrician"
...
const CARD = {
  ...
  slug: 'trainee-electrician',
  desc: `For trainees working towards a full electrician qualification.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Trainee Electrician card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Trainee Electrician card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Trainee Electrician the right card for my role?`, a: `It's one of several routes under Electrical Trades. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function TraineeElectricianPage() {
