// pages/ecs-cards/VehicleInstallerPage.jsx — dedicated ECS card page for "Vehicle Installer"
...
const CARD = {
  name: `Vehicle Installer`,
  slug: 'vehicle-installer',
  desc: `For workers installing electrical and electronic systems in vehicles.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Vehicle Installer card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Vehicle Installer card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Vehicle Installer the right card for my role?`, a: `It's one of several routes under Other Specialist Routes. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function VehicleInstallerPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            <Link
              to="/ecs-cards/gate-safe-installer"
            ...
            >
              ...
              <div>
                <div className="text-sm font-semibold text-gray-900">Gate Safe Installer</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Automatic gate and barrier installation specialist route.</p>
              </div>
            </Link>
