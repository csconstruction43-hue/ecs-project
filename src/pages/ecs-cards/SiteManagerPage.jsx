// pages/ecs-cards/SiteManagerPage.jsx — dedicated ECS card page for "Site Manager"
...
const CARD = {
  name: `Site Manager`,
  slug: 'site-manager',
  desc: `Site management card for leading projects and delivery on site.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Site Manager card?`, a: `Yes. This route sits behind the MAP HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Site Manager card last?`, a: `5 years, in line with the Black / White Card (Manager) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Site Manager the right card for my role?`, a: `It's one of several routes under Site Management. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link
              to="/ecs-cards/project-manager"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">Project Manager</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Management-level route for project planning and coordination.</p>
              </div>
            </Link>
        </div>
      </section>
