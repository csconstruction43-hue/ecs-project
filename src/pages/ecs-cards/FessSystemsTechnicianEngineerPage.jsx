// pages/ecs-cards/FessSystemsTechnicianEngineerPage.jsx — dedicated ECS card page for "FESS Systems Technician / Engineer"
...
const CARD = {
  name: `FESS Systems Technician / Engineer`,
  slug: 'fess-systems-technician-engineer',
  desc: `Higher-level FESS card for technicians and engineers.`,
...
const faqs = [
    { q: `Do I need to sit a test for the FESS Systems Technician / Engineer card?`, a: `Yes. This route sits behind the Operatives or Specialist HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the FESS Systems Technician / Engineer card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is FESS Systems Technician / Engineer the right card for my role?`, a: `It's one of several routes under Fire, Emergency & Security Systems (FESS). If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function FessSystemsTechnicianEngineerPage() {
