// pages/ecs-cards/CreativeProductionManagerPage.jsx — dedicated ECS card page for "Creative Production Manager"
...
const CARD = {
  name: `Creative Production Manager`,
  slug: 'creative-production-manager',
  desc: `Management-level card for leading creative and live event teams.`,
  path: '/ecs-black-card-mock-test',
  category: 'av',
}
...
const faqs = [
    { q: `Do I need to sit a test for the Creative Production Manager card?`, a: `Yes. This route sits behind the MAP HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Creative Production Manager card last?`, a: `5 years, in line with the Black / White Card (Manager) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Creative Production Manager the right card for my role?`, a: `It's one of several routes under AV, Broadcast & Creative Production. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function CreativeProductionManagerPage() {
