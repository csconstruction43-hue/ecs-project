// pages/ecs-cards/ApprovedElectricianGoldPage.jsx — dedicated ECS card page for "Approved Electrician (Gold)"
...
const CARD = {
  name: `Approved Electrician (Gold)`,
  slug: 'approved-electrician-gold',
  desc: `Gold card for electricians assessed to Approved Electrician level.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Approved Electrician (Gold) card?`, a: `Yes. This route sits behind the Operatives or Specialist HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Approved Electrician (Gold) card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Approved Electrician (Gold) the right card for my role?`, a: `It's one of several routes under Electrical Trades. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function ApprovedElectricianGoldPage() {
