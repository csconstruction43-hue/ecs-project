// pages/ecs-cards/FessLabourerPage.jsx — dedicated ECS card page for "FESS Labourer"
...
const CARD = {
  name: `FESS Labourer`,
  slug: 'fess-labourer',
  desc: `Entry-level labouring card within the FESS occupational structure.`,
...
const faqs = [
    { q: `Do I need to sit a test for the FESS Labourer card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the FESS Labourer card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is FESS Labourer the right card for my role?`, a: `It's one of several routes under Fire, Emergency & Security Systems (FESS). If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function FessLabourerPage() {
