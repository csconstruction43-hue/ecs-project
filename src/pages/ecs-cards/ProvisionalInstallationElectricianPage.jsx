// pages/ecs-cards/ProvisionalInstallationElectricianPage.jsx — dedicated ECS card page for "Provisional Installation Electrician"
...
const CARD = {
  name: `Provisional Installation Electrician`,
  slug: 'provisional-installation-electrician',
  desc: `Provisional card while final evidence for the full installation route is completed.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Provisional Installation Electrician card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Provisional Installation Electrician card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Provisional Installation Electrician the right card for my role?`, a: `It's one of several routes under Electrical Trades. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function ProvisionalInstallationElectricianPage() {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link
              to="/ecs-cards/approved-electrician-gold"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">Approved Electrician (Gold)</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Gold card for electricians assessed to Approved Electrician level.</p>
              </div>
            </Link>
        </div>
      </section>
