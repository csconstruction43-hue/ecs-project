// pages/ecs-cards/SignalDistributionSpecialistPage.jsx — dedicated ECS card page for "Signal Distribution Specialist"
...
const CARD = {
  name: `Signal Distribution Specialist`,
  slug: 'signal-distribution-specialist',
  desc: `Specialist in distribution of broadcast and signal systems.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Signal Distribution Specialist card?`, a: `Yes. This route sits behind the Operatives or Specialist HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Signal Distribution Specialist card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Signal Distribution Specialist the right card for my role?`, a: `It's one of several routes under Network & Telecoms. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function SignalDistributionSpecialistPage() {
