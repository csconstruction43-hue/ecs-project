// pages/ecs-cards/GateSafeInstallerPage.jsx — dedicated ECS card page for "Gate Safe Installer"
...
import {
  ShieldCheck, ClipboardCheck, Clock, Banknote, ChevronRight, ChevronDown,
...
const CARD = {
  name: `Gate Safe Installer`,
  slug: 'gate-safe-installer',
  desc: `Automatic gate and barrier installation specialist route.`,
  path: '/ecs-green-card-mock-test',
  category: 'other',
}
const CATEGORY = { id: 'other', name: `Other Specialist Routes`, desc: `Vehicle, lighting and other specialist installer occupations.` }
const META = {
...
const faqs = [
    { q: `Do I need to sit a test for the Gate Safe Installer card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Gate Safe Installer card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Gate Safe Installer the right card for my role?`, a: `It's one of several routes under Other Specialist Routes. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function GateSafeInstallerPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Related cards */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        <h2 className="text-xl font-bold text-gray-900 mb-1">Other cards in Other Specialist Routes</h2>
        <p className="text-gray-500 text-sm mb-6">Not quite the right fit? These sit in the same occupational group.</p>
        <div className="grid sm:grid-cols-3 gap-4">
            <Link
              to="/ecs-cards/vehicle-installer"
            ...
            >
              ...
              <div>
                <div className="text-sm font-semibold text-gray-900">Vehicle Installer</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">For workers installing electrical and electronic systems in vehicles.</p>
              </div>
            </Link>

            <Link
              to="/ecs-cards/sll-lighting-professional"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">SLL Lighting Professional</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Lighting design and consultancy route recognised by the SLL.</p>
              </div>
            </Link>
        </div>
      </section>
