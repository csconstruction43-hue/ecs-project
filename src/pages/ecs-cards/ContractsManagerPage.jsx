// pages/ecs-cards/ContractsManagerPage.jsx — dedicated ECS card page for "Contracts Manager"
...
const CARD = {
  ...
  desc: `Senior card route for managing contracts and commercial delivery.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Contracts Manager card?`, a: `Yes. This route sits behind the MAP HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Contracts Manager card last?`, a: `5 years, in line with the Black / White Card (Manager) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Contracts Manager the right card for my role?`, a: `It's one of several routes under Site Management. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
