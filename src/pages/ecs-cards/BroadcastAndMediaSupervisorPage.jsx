// pages/ecs-cards/BroadcastAndMediaSupervisorPage.jsx — dedicated ECS card page for "Broadcast & Media Supervisor"
...
const CARD = {
  name: `Broadcast & Media Supervisor`,
  slug: 'broadcast-and-media-supervisor',
  desc: `Supervisory card for broadcast and media technical operations.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Broadcast & Media Supervisor card?`, a: `Yes. This route sits behind the Supervisors HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Broadcast & Media Supervisor card last?`, a: `5 years, in line with the Gold Card (Supervisor) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Broadcast & Media Supervisor the right card for my role?`, a: `It's one of several routes under AV, Broadcast & Creative Production. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function BroadcastAndMediaSupervisorPage() {
