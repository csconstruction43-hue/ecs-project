// pages/ecs-cards/NetworkInfrastructureInstallerPage.jsx — dedicated ECS card page for "Network Infrastructure Installer"
...
const CARD = {
  name: `Network Infrastructure Installer`,
  slug: 'network-infrastructure-installer',
  desc: `Installer and technician levels for network infrastructure routes.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Network Infrastructure Installer card?`, a: `Yes. This route sits behind the Operatives or Specialist HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Network Infrastructure Installer card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Network Infrastructure Installer the right card for my role?`, a: `It's one of several routes under Network & Telecoms. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function NetworkInfrastructureInstallerPage() {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link
              to="/ecs-cards/telecommunications-fitter"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">Telecommunications Fitter</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Installer and maintenance card for telecoms fitting work.</p>
              </div>
            </Link>
        </div>
      </section>
