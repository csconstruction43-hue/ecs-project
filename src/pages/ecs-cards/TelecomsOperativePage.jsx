// pages/ecs-cards/TelecomsOperativePage.jsx — dedicated ECS card page for "Telecoms Operative"
...
const CARD = {
  name: `Telecoms Operative`,
  slug: 'telecoms-operative',
  desc: `Operative-level card for general telecoms field work.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Telecoms Operative card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Telecoms Operative card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Telecoms Operative the right card for my role?`, a: `It's one of several routes under Network & Telecoms. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function TelecomsOperativePage() {
