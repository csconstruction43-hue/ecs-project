...
const faqs = [
    ...
    { q: `How long does the Experienced Worker (Gold Stripe – Temp) card last?`, a: `5 years (1 year on the temporary Experienced Worker route), in line with the Blue / Gold Card (Skilled Worker) it belongs to. Always confirm the current rule for your exact route at ecs.uk.com.` },
