// pages/ecs-cards/AvOperativeAvTechnicianPage.jsx — dedicated ECS card page for "AV Operative / AV Technician"
...
const CARD = {
  name: `AV Operative / AV Technician`,
  slug: 'av-operative-av-technician',
  desc: `Audio-visual technician and operative roles across venues and events.`,
...
const faqs = [
    { q: `Do I need to sit a test for the AV Operative / AV Technician card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the AV Operative / AV Technician card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is AV Operative / AV Technician the right card for my role?`, a: `It's one of several routes under AV, Broadcast & Creative Production. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function AvOperativeAvTechnicianPage() {
