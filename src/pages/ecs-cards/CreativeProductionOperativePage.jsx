// pages/ecs-cards/CreativeProductionOperativePage.jsx — dedicated ECS card page for "Creative Production Operative"
...
const CARD = {
  name: `Creative Production Operative`,
  slug: 'creative-production-operative',
  desc: `Supporting technical work in stage, theatre and live events.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Creative Production Operative card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Creative Production Operative card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Creative Production Operative the right card for my role?`, a: `It's one of several routes under AV, Broadcast & Creative Production. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function CreativeProductionOperativePage() {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link
              to="/ecs-cards/creative-production-technician"
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-sm transition-all"
            >
              <ClipboardCheck size={16} className="text-blue-500 mt-0.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-gray-900">Creative Production Technician</div>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">Technical role supporting creative and live event production.</p>
              </div>
            </Link>
        </div>
      </section>
