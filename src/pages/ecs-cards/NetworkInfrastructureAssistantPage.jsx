// pages/ecs-cards/NetworkInfrastructureAssistantPage.jsx — dedicated ECS card page for "Network Infrastructure Assistant"
...
const CARD = {
  name: `Network Infrastructure Assistant`,
  slug: 'network-infrastructure-assistant',
  desc: `Assistant-level card for network and structured cabling work.`,
...
const faqs = [
    { q: `Do I need to sit a test for the Network Infrastructure Assistant card?`, a: `Yes. This route sits behind the Operatives HS&E test, the same core HS&E assessment ECSPrep's mock tests are built to prepare you for.` },
    { q: `How long does the Network Infrastructure Assistant card last?`, a: `2 years first-time, 5 years on renewal, in line with the Green Card (Operative) it belongs to. Always confirm the current rule for your exact route at ecscard.org.uk.` },
    ...
    { q: `Is Network Infrastructure Assistant the right card for my role?`, a: `It's one of several routes under Network & Telecoms. If you're not sure, browse the other cards in this category below or use the card finder on our ECS Cards page.` },
    ...(ABOUT?.extraFaqs || []),
]
...
export default function NetworkInfrastructureAssistantPage() {
